...
func InstallNinjaAndGn() {
	// 下载并解压gn
	err := downloadAndUnzip("https://chrome-infra-packages.appspot.com/dl/gn/gn/windows-amd64/+/latest", "gn.zip", "third_party/externals/gn")
	if err != nil {
	...
	// 设置环境变量
	err = setEnvPath("third_party/externals/gn")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}
	...
	err = copyFile("third_party/externals/gn/gn.exe", "C:/Windows/System32/gn.exe")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}
	...
	// 下载并解压ninja
	err = downloadAndUnzip("https://github.com/ninja-build/ninja/releases/download/v1.10.2/ninja-win.zip", "ninja.zip", "third_party/externals/ninja")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}
	...
	// 设置环境变量
	err = setEnvPath("third_party/externals/ninja")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}
	...
	err = copyFile("third_party/externals/ninja/ninja.exe", "C:/Windows/System32/ninja.exe")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}
